function HarmonizedDWIPaths=harmonization_touchRef(xlsFilePath_REF, REF_name, xlsFilePath_OTHER, OTHER_name, option, templatesPath )
...
[HarmonizedDWIPaths, SITES] = harmonize_CleanOutliers_touchRef(SITES,templatesPath, option);
