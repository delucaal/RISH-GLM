...
function createTemplateBasedOnExisting_aluca(SITES,templatesPath,existing_template,option)
...
%     end
    ...
    for s=1:length(SITES)
        for l=0:2:SHorder
            ...
            nii.img = RobustAverage(temp{1});%mean(temp{1},4);
...
function medv = RobustAverage(Vol4D)
